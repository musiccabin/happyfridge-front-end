  ...
  return (
    ...
    >
      <Tab.Screen name='To Buy'>
        {() => <IngredientList data={toBuy} componentName={"AddEditGrocery"} titles={toBuyTitles} iconName='check' />}
      </Tab.Screen>
      <Tab.Screen name='Completed'>
        {() => <IngredientList data={completed} componentName={"AddEditGrocery"} titles={completedTitles} iconName='add' />}
      </Tab.Screen>
    </Tab.Navigator>
  )
}
